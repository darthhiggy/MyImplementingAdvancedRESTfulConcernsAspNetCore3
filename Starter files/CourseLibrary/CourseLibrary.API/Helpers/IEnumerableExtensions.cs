...
namespace CourseLibrary.API.Helpers
{
    public static class IEnumerableExtensions
    {
        public static IEnumerable<ExpandoObject> ShapeData<TSource>(this IEnumerable<TSource> source, string fields)
        {
            ...
            // create a list with PropertyInfo objects on TSource. Reflection is expensive, so rather than doing it for each object in the list, we do it once and reuse the results.
            // After all, part of the reflection is on the type of the object (TSource), no on the instance. 
